...
namespace SharpNeat.EvolutionAlgorithms
{
    ...
    public class NeatAlgorithmStats
    {
        ...
        public uint _generationReachedThreshold;

        public double _maxAltFitness;

        public List<double> _maxAltFitnessList = new List<double>();
        public List<double> _avgAltFitnessList = new List<double>();
